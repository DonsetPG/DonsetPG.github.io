...
This blog post contains a small introduction to Finite Element Methods and Graph Neural Networks.^{sidenote|Here's an example sidenote. On large screens it appears in the right margin, and on mobile it stays near this sentence.} This may or may not be to serve as future support for a paper.
