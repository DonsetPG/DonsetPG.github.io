...
* First, you have to draw 30 cards from a pool of 160 cards. During 30 turns, the game will propose you three cards and you have to choose the one you wanna pick.
* After that, each player will play. I can do several actions: summon a creatures, attack the opponent, use an item, etc.
...
![locam-1]({{ site.url }}/imgs/2019-08-06-DRL-FM-review/LOCAM-eg-card.png)
