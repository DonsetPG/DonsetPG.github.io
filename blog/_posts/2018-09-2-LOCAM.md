...
<center>
<em>
An overview of the beginning of a tic-tac-toe game, reproduced from [Medium](https://medium.com/@quasimik/monte-carlo-tree-search-applied-to-letterpress-34f41c86e238).
</em>
</center>
...
<center>
<em>
Explanation of an MCTS -  [Chaslot (2006)](https://medium.com/@quasimik/monte-carlo-tree-search-applied-to-letterpress-34f41c86e238).
</em>
</center>
...
where $B_{me}$ ($B_{opponent}$) is my board (the opponent's board), and $f$ is an evaluation function for each card, that takes the following (complex form) :
