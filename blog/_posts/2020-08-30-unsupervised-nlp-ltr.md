...
* We consider $f$ as a **univariate** scoring function, meaning that it can be decomposed into a per-item scoring function such as $f(X)_i = u(x_i)$ with $u : x \mapsto \mathbb{R}_+$. We will have $f(X) = [u(x_0), \cdots , u(x_n)]$. 
