...
![png]({{ site.url }}/imgs/2020-08-20-Narya/output_4_1.png)
...
The model is based on a Resnet-18 architecture and takes images of shape $(280,280)$. It was implemented with Keras. Let's review it's architecture, which is kept the same for each model no matter its framework. 
...
![png]({{ site.url }}/imgs/2020-08-20-Narya/output_26_0.png)
