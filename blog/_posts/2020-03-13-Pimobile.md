...
We wanted to be a bit more ambitious and step aside from the small inside track we used for the first car. We used a small pathway around my home as a circuit. This pathway lies inside a large garden, making it easy to define where the car should drive and make a loop: precisely what we needed.
...
We trained the model twice: once without data augmentation and once including it. The data augmentation consisted of adding some random modifications regarding:
* Brightness
* Small rotation
