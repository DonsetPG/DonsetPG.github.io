...
Overall, we should have made a better dataset, mainly making sure we had no steering issues. This made the testing difficult, forcing us to add an artificial left steering and to make the car starts with the proper steering (same angle as in the dataset). 
